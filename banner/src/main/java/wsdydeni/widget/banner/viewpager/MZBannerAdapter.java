...
public class MZBannerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        imageView.setBackground(ResourcesCompat.getDrawable(container.getContext().getResources(), R.drawable.round_image,null));
        ...
        if(mOnItemClickListener != null) {
            imageView.setOnClickListener(v -> mOnItemClickListener.click(realPosition,mDataList.get(realPosition)));
        }
