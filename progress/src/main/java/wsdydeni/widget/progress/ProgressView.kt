package wsdydeni.widget.progress
...
class ProgressView : View {
    ...
    private fun dp2px(context: Context, dp : Float) : Int = (dp * context.resources.displayMetrics.density + 0.5f).toInt()

    private fun initView(attributeSet: AttributeSet?) {
        defaultOutBounderSize = dp2px(context,1f).toFloat()
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val defaultWidth = dp2px(context,55f)
        val defaultHeight = dp2px(context,55f)
